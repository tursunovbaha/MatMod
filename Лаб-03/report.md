...
subtitle: "Модель боевых действий - вариант 54"
...
В начальный момент времени страна $X$ имеет армию численностью 87700 человек, а в распоряжении страны $Y$ армия численностью в 91400 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.505(t) - 0.77y(t) + sin(2t)+2
	\\   
